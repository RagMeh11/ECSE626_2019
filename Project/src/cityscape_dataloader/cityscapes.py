...
from .visionc import VisionDataset
...
class Cityscapes(VisionDataset):
    ...
    Examples:
        ...
        .. code-block:: python
            dataset = Cityscapes('./data/cityscapes', split='train', mode='fine',
                                 target_type=['instance', 'color', 'depth'])
            img, (inst, col, depth) = dataset[0]
    ...
    def __init__(self, root, split='train', mode='fine', target_type='instance',
        ...
        if not all(t in ['instance', 'semantic', 'polygon', 'color', 'depth'] for t in self.target_type):
            raise ValueError('Invalid value for "target_type"! Valid values are: "instance", "depth", "semantic", "polygon"'
                             ' or "color"')
    ...
    def __getitem__(self, index):
        ...
        for i, t in enumerate(self.target_type):
            ...
            if self.target_transform:
                target = self.target_transform[i](target)
    ...
    def _get_target_suffix(self, mode, target_type):
        if target_type == 'instance':
            ...
            return 'disparity.png'.format(mode)
        else:
