...
def main(config):
    ...
    val_metric = validate()
    print("===> Validation Epoch {}: Loss - {:.4f}, Loss_Seg - {:.4f}, Loss_Reg - {:.4f}, mean IoU - {:.4f}, MSE - {:.4f}, MAE - {:.4f}".format(initial_epoch, val_metric[0], val_metric[1], val_metric[2], val_metric[7], val_metric[8], val_metric[9]))
