...
def main(config):
    ...
    ConfigName = 'Seg_Depth_optimal'                                                     # Configuration Name to Uniquely Identify this Experiment
    ...
    val_metric = validate()
    print("===> Validation Epoch {}: Loss - {:.4f}, Loss_Seg - {:.4f}, Loss_Reg - {:.4f}, mean IoU - {:.4f}, MSE - {:.4f}, MAE - {:.4f}".format(initial_epoch, val_metric[0], val_metric[1], val_metric[2], val_metric[3], val_metric[4], val_metric[5]))
