...
def main(config):
    ...
    for epch in range(initial_epoch, num_epochs):
        ...
        if epch % 2 == 0:
            ...
            train_metric = test()
            print("===> Training   Epoch {}: Loss - {:.4f}, mean IoU - {:.4f}".format(epch, train_metric[0], train_metric[1]))
            ...
            val_metric = validate()
            print("===> Validation Epoch {}: Loss - {:.4f}, mean IoU - {:.4f}".format(epch, val_metric[0], val_metric[1]))
